    ...
    <section class="bg-gray-700 py-12 mb-12">
       <div class="container grid grid-cols-1 lg:grid-cols-2 gap-6">
           <figure>
            ...
            @else
             <img class="h-60 w-full object-cover" src="https://images.pexels.com/photos/4497759/pexels-photo-4497759.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500" alt="">
             @endif
           </figure>
        ...
        <div class="order-1 lg:order-2">
            <section class="card mb-6">
                <div class="card-body">
                    ...
                    <a  class="btn btn-danger w-full block text-center mt-4" href="{{route('admin.courses.observation',$course)}}">Observaciones curso</a>
                </div>
            </section>
